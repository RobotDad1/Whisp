...
function BorderAnimatedContainer({ children }) {
  ...
  const darkClasses = "[background:linear-gradient(45deg,#0f172a,#0f172a)_padding-box,conic-gradient(from_var(--border-angle),#0f172a_80%,_#FFD700_86%,_#FFC107_90%,_#FFD700_94%,_#0f172a)_border-box] animate-border";
